...
const Blog = (): JSX.Element => {
  ...
  return (
    ...
    {!loading && <div className="flex flex-col items-center p-10 sm:px-20 gap-10 md:grid md:grid-cols-12 md:p-20 md:px-30 lg:p-20 lg:px-40 md:items-start md:gap-0">
      ...
      <div className="flex flex-col gap-2 pt-5 md:col-span-4 self-end">
        ...
        <div className="flex gap-4 items-center">
          <div>
            <Avatar authorName={blog?.author.name.toUpperCase()} size={"small"}/>
          </div>
